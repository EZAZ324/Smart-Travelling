...
void about_us()
{
    ...
    */
    ...
    printf("\t\t\t1.\tNAME : Md. Ezaz Ahmed Shikdar\n");
    printf("\t\t\t\t  ID : 232-15-403\n");
    printf("\t\t\t\tMAIL : ezaz2305101403@diu.edu.bd\n");
    printf("\t\t\t     CONTACT : 01644700562");

    printf("\n\n\t\t\t2.\tNAME : Md. Ashfikur Rahman Adib\n");
    printf("\t\t\t\t  ID : 232-15-164\n");
    printf("\t\t\t\tMAIL : adib2305101164@diu.edu.bd\n");
    printf("\t\t\t     CONTACT : 01793961532");

    printf("\n\n\t\t\t3.\tNAME : Md. Ijaj Hakim Arfique\n");
    printf("\t\t\t\t  ID : 232-15-283\n");
    printf("\t\t\t\tMAIL : ijaj2305101283@diu.edu.bd\n");
    printf("\t\t\t     CONTACT : 01603539123");

    printf("\n\n\t\t\t4.\tNAME : Bijoy Krishna Sarker\n");
    printf("\t\t\t\t  ID : 232-15-219\n");
    printf("\t\t\t\tMAIL : bijoy2305101219@diu.edu.bd\n");
...
summary_bro()
{
    ...
    printf("This project is mainly based on location tracking inside the Daffodil International University.\n\n");
    printf("Daffodil International University has a large campus of 18 acres. So it become very difficult for new student to find anything in the campus. We covered 18 locations within these project. Everytime we started from the MAIN GATE. One can choose your location from our well designed list. After choosing the destination the program will generate a map by giving instruction for your desired path. By following that path you can get your destination.\n\n");
